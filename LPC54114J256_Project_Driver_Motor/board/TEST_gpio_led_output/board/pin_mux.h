...
/*! @name PIO0_31 (number 13), J2[17]/J3[2]/P1[7]/U3[4]/SW2/P0_31-PDM0_CLK-ISP0_EN
  @{ */
#define BOARD_INITPINS_BOARD_TEST_LED_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_BOARD_TEST_LED_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_INITPINS_BOARD_TEST_LED_PIN 31U   /*!<@brief 0U pin index: 31 */
                                                /* @} */

/*! @name PIO1_12 (number 51), J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1
  @{ */
#define BOARD_INITPINS_SPEED_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_SPEED_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_SPEED_PIN 12U   /*!<@brief 1U pin index: 12 */
                                       /* @} */
