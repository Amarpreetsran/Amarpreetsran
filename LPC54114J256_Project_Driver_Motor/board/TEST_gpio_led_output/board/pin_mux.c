...
- {pin_num: '13', pin_signal: PIO0_31/PDM0_CLK/FC2_CTS_SDA_SSEL0/CTIMER2_CAP2/CTIMER0_CAP3/CTIMER0_MAT3/ADC0_2, label: 'J2[17]/J3[2]/P1[7]/U3[4]/SW2/P0_31-PDM0_CLK-ISP0_EN',
  identifier: SW2;BOARD_TEST_LED}
- {pin_num: '51', pin_signal: PIO1_12/FC5_RXD_SDA_MOSI/CTIMER1_MAT0/FC7_SCK/UTICK_CAP2, label: 'J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1', identifier: p;SPEED}
...
- pin_list:
  ...
  - {pin_num: '13', peripheral: GPIO, signal: 'PIO0, 31', pin_signal: PIO0_31/PDM0_CLK/FC2_CTS_SDA_SSEL0/CTIMER2_CAP2/CTIMER0_CAP3/CTIMER0_MAT3/ADC0_2, identifier: BOARD_TEST_LED,
    direction: INPUT, mode: pullUp, invert: disabled, glitch_filter: disabled, open_drain: disabled}
  - {pin_num: '51', peripheral: GPIO, signal: 'PIO1, 12', pin_signal: PIO1_12/FC5_RXD_SDA_MOSI/CTIMER1_MAT0/FC7_SCK/UTICK_CAP2, identifier: SPEED, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t BOARD_TEST_LED_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_31 (pin 13)  */
    GPIO_PinInit(BOARD_INITPINS_BOARD_TEST_LED_GPIO, BOARD_INITPINS_BOARD_TEST_LED_PORT, BOARD_INITPINS_BOARD_TEST_LED_PIN, &BOARD_TEST_LED_config);

    gpio_pin_config_t SPEED_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_12 (pin 51)  */
    GPIO_PinInit(BOARD_INITPINS_SPEED_GPIO, BOARD_INITPINS_SPEED_PORT, BOARD_INITPINS_SPEED_PIN, &SPEED_config);
    ...
    const uint32_t BOARD_TEST_LED = (/* Pin is configured as PIO0_31 */
                                     IOCON_PIO_FUNC0 |
                                     /* Selects pull-up function */
                                     IOCON_PIO_MODE_PULLUP |
                                     /* Input function is not inverted */
    ...
    IOCON_PinMuxSet(IOCON, BOARD_INITPINS_BOARD_TEST_LED_PORT, BOARD_INITPINS_BOARD_TEST_LED_PIN, BOARD_TEST_LED);
