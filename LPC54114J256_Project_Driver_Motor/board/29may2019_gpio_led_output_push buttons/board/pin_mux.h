...
/*! @name PIO0_31 (number 13), J2[17]/J3[2]/P1[7]/U3[4]/SW2/P0_31-PDM0_CLK-ISP0_EN
  @{ */
#define BOARD_INITPINS_SW2_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_SW2_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_INITPINS_SW2_PIN 31U   /*!<@brief 0U pin index: 31 */
                                     /* @} */
...
/*! @name PIO1_15 (number 62), J1[17]/P1_15-SCTO5-FC7_CTS
  @{ */
#define BOARD_INITPINS_DR1_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_DR1_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_DR1_PIN 15U   /*!<@brief 1U pin index: 15 */
                                     /* @} */

/*! @name PIO1_1 (number 15), J1[15]/P1_1-FC5_SSEL2
  @{ */
#define BOARD_INITPINS_SP1_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_SP1_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_SP1_PIN 1U    /*!<@brief 1U pin index: 1 */
                                     /* @} */

/*! @name PIO1_14 (number 57), J2[1]/P1_14-SCTO7
  @{ */
#define BOARD_INITPINS_DR2_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_DR2_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_DR2_PIN 14U   /*!<@brief 1U pin index: 14 */
                                     /* @} */
